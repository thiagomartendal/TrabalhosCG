...
class Normalizacao:
    ...
    def __normalizacao3D(self, objeto):
        segmentos = []
        for segmento in objeto.getSegmentosFixos():
    ...
    def normalizar(self, objeto):
        if objeto.dimensao() == 2:
            ...
            segmentos = self.__normalizacao3D(objeto)
            objeto.setSegmentosNormalizados(segmentos)
