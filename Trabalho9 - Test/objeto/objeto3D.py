...
class Objeto3D(ABC):
    ...
    __segmentosNormalizados2 = []
    __segmentos2 = [] # Vetor de segmentos de reta
    __cor = (0,0,0)
    ...
    # Atualiza a lista de pontos normalizados
    def setSegmentosNormalizados2(self, novosSegmentos):
        self.__segmentosNormalizados2.clear()
        self.__segmentosNormalizados2 = [s for s in novosSegmentos]
        
    # Retorna os pontos normalizados
    def getSegmentosNormalizados2(self):
        return self.__segmentosNormalizados2

    # Atualiza a lista de pontos normalizados
    def setSegmentos2(self, novosSegmentos):
        self.__segmentos2.clear()
        self.__segmentos2 = [s for s in novosSegmentos]
        
    # Retorna os pontos normalizados
    def getSegmentos2(self):
        return self.__segmentos2
