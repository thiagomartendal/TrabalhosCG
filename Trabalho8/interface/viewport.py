...
class Viewport(QFrame):
    ...
    def __eixos(self):
        tamanho = 100
        eixoX1 = Objeto3D('EixoX1', [SegmentoReta(Ponto3D(-tamanho,0,0), Ponto3D(0,0,0))])
        eixoX2 = Objeto3D('EixoX2', [SegmentoReta(Ponto3D(0,0,0), Ponto3D(tamanho,0,0))])
        eixoX1.setCor(255,150,150)
        eixoX2.setCor(255,150,150)
        eixoY1 = Objeto3D('EixoY1', [SegmentoReta(Ponto3D(0,-tamanho,0), Ponto3D(0,0,0))])
        eixoY2 = Objeto3D('EixoY2', [SegmentoReta(Ponto3D(0,0,0), Ponto3D(0,tamanho,0))])
        eixoY1.setCor(150,255,150)
        eixoY2.setCor(150,255,150)
        eixoZ1 = Objeto3D('EixoZ1', [SegmentoReta(Ponto3D(0,0,-tamanho), Ponto3D(0,0,0))])
        eixoZ2 = Objeto3D('EixoZ2', [SegmentoReta(Ponto3D(0,0,0), Ponto3D(0,0,tamanho))])
