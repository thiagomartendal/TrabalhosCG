...
class Window():
    ...
    # Set COP pra uma distancia 'd' do ponto
    def setDistanciaCOP(self, d):
        self.__COPdistancia = d

    # get distancia do COP pra window
    def getDistanciaCOP(self):
        return self.__COPdistancia
