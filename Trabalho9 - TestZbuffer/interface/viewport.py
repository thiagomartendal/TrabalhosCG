...
class Viewport(QFrame):
    ...
    def __init__(self, window, parent=None):
        ...
        self.__zBuffer = ZBuffer(self.painel, self.__coordenadas, self.__window)
    ...
    def renderizar(self, objetos):
        ...
        self.__zBuffer.atualizar(objetos3D)
        self.__zBuffer.renderizar()
    ...
    def __criarViewportRetangulo(self, c):
        ...
        view.setPontos([EstruturaPonto(c[0]-1,c[1]-1),
                        EstruturaPonto(c[2]+1,c[1]-1),
                        EstruturaPonto(c[2]+1,c[3]+1),
                        EstruturaPonto(c[0]-1,c[3]+1)])
