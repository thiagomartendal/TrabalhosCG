...
class Objeto3D(ABC):
    ...
    __segmentosNormalizadosComZ = []
    __segmentosComZ = [] # Vetor de segmentos de reta com Z
    __cor = (0,0,0)
    ...
    # Atualiza a lista de pontos normalizados em perspectiva
    def setSegmentosNormalizadosComZ(self, novosSegmentos):
        self.__segmentosNormalizadosComZ.clear()
        self.__segmentosNormalizadosComZ = [s for s in novosSegmentos]
        
    # Retorna os pontos normalizados  em perspectiva
    def getSegmentosNormalizadosComZ(self):
        return self.__segmentosNormalizadosComZ

    # Atualiza a lista de pontos em perspectiva
    def setSegmentosComZ(self, novosSegmentos):
        self.__segmentosComZ.clear()
        self.__segmentosComZ = [s for s in novosSegmentos]
        
    # Retorna os pontos em perspectiva
    def getSegmentosComZ(self):
        return self.__segmentosComZ
